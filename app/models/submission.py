...
class Submission(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(GUID(), primary_key=True, default=uuid.uuid4)  # 提交记录ID
    task_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("tasks.id"), unique=True, nullable=False, index=True)  # 对应任务ID（一任务一提交）
